...
// numbers
SIGN_PRECISION_9:
      (PRECISION_9 SIGN_CHAR?)
    | (SIGN_CHAR? PRECISION_9)
    ;

PRECISION_9:
      (S? LENGTH_TYPE_9)
    | (S? LENGTH_TYPE_9 DOT LENGTH_TYPE_9)
    | (S? LENGTH_TYPE_9? V ((LENGTH_TYPE_P LENGTH_TYPE_9)? | LENGTH_TYPE_9?))
    | (S? LENGTH_TYPE_9 LENGTH_TYPE_P?)
    | (LENGTH_TYPE_Z LENGTH_TYPE_9 DOT LENGTH_TYPE_9)
    | (LENGTH_TYPE_Z LENGTH_TYPE_9? V ((LENGTH_TYPE_P LENGTH_TYPE_9)? | LENGTH_TYPE_9?))
    | (LENGTH_TYPE_Z LENGTH_TYPE_9? LENGTH_TYPE_P?)
    ;
